  ...
  const listVoices = createTool({
    ...
    execute: async () => {
      ...
      const voices = rows.length ? rows.map(v => {
        ...
        ? [
          { id: 'zh-CN-XiaoxiaoNeural', name: '晓晓', gender: '女声', traits: '温柔、自然、甜美', suitable_for: '女主、旁白、温柔女性', language: '中文（普通话）', provider },
          { id: 'zh-CN-YunxiNeural', name: '云希', gender: '男声', traits: '阳光、年轻、活力', suitable_for: '男主、年轻男性', language: '中文（普通话）', provider },
          { id: 'zh-CN-YunjianNeural', name: '云健', gender: '男声', traits: '沉稳、有力、成熟', suitable_for: '成熟男性、旁白', language: '中文（普通话）', provider },
          { id: 'zh-CN-XiaoyiNeural', name: '晓依', gender: '女声', traits: '活泼、可爱、年轻', suitable_for: '少女、活泼角色', language: '中文（普通话）', provider },
